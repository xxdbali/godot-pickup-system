...
func _init(p_base_entity_id: int, tscn_scene_path: String = "", p_qty: int = 1, p_transform: Transform3D = Transform3D(), p_inventory_slot_index: int = -1) -> void:
	...
	item_scene_path = tscn_scene_path
